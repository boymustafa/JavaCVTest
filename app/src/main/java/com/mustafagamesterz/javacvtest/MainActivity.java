package com.mustafagamesterz.javacvtest;
...
//    private String ffmpeg_link = " /sdcard/stream.flv";
    private String ffmpeg_link = Environment.getExternalStorageDirectory().toString()+"/stream.flv";
//    private String ffmpeg_link = "rtmp://128.199.74.207/live/abc";
...
//    final int RECORD_LENGTH = 10;
    ...
    private void initLayout(){
        ...
        myInflate = (LayoutInflater) getSystemService(LAYOUT_INFLATER_SERVICE);
        ...
        int display_height_d = (int) (1.0 * bg_screen_height * screenHeight / bg_screen_height);
        int prev_rw, prev_rh;
        if(1.0 * display_width_d/display_height_d > 1.0 * live_width / live_height){
            prev_rh = display_height_d;
            prev_rw = (int) (1.0 * display_height_d * live_height / live_width);
        }
        else {
